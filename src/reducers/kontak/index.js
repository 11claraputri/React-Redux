    ...
    switch (action.type) {
        case GET_LIST_KONTAK:
            return {
                ...
                getListKontakError: action.payload.erroMessage
        ...
        case ADD_KONTAK:
            return {
                ...
                addKontakError: action.payload.erroMessage
        ...
        case DELETE_KONTAK:
            return {
                ...
                deleteKontakError: action.payload.erroMessage
        ...
        case UPDATE_KONTAK:
            return {
                ...
                updateKontakError: action.payload.erroMessage
